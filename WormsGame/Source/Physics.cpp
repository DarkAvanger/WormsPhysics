...
public:
	...
	float radius = 4.0f;	// Circle for collision
	bool bStable = false;	// Object stopped moving
	float fFriction = 0.8f;	// Friction

	int nBounceBeforeDeath = -1;	// How many time object can bounce before death (-1 infinite times)
...
private:
	...
	// Taken from Perlin Noise Algorithm
